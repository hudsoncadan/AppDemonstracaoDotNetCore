...
{
    /// <summary>
    /// Validação de Moeda (valores decimais) em server-side
    /// </summary>
    ...
    /// <summary>
    /// Validação de Moeda (valores decimais) em client-side
    /// </summary>
    ...
    /// <summary>
    /// Provider adicionado como Singleton no Startup para utilização do MoedaAttributeAdapter 
    /// </summary>
